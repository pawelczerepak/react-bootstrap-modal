...
var Modal = function (_React$Component) {
  ...
  Modal.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        enforceFocus = _props.enforceFocus,
        props = _objectWithoutProperties(_props, ['className', 'children', 'keyboard', 'transition', 'modalPrefix', 'dialogClassName', 'container', 'onEnter', 'onEntered', 'onExit', 'onExited', 'enforceFocus']);
    ...
    var modal = _react2.default.createElement(
      ...
      _extends({}, elementProps, {
        ...
        onMouseDown: this.props.backdrop ? function (e) {
          return _this3.handleBackdropMouseDown(e);
        } : null,
        onMouseUp: this.props.backdrop ? function (e) {
          return _this3.handleBackdropMouseUp(e);
        } : null
      }),
  ...
  Modal.prototype.handleBackdropMouseDown = function handleBackdropMouseDown(e) {
    this._waitingForMouseUp = true;
    this._mouseDownTarget = e.target;
  };

  Modal.prototype.handleBackdropMouseUp = function handleBackdropMouseUp(e) {
